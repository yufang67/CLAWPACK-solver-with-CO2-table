...
!
PRIVATE
PUBLIC  New_Rap2D, New_Rap3D, New_Rap1D
CONTAINS
!
!
!
...
! Global variables
      ...
      REAL(pr),INTENT(IN)  :: guess_1, guess_2, in_1, in_2
...
!
        ...
        qual = (v - v_l)/(v_v-v_l)
        out_2 = qual
        F = (e - qual*e_v - (1_pr - qual)*e_l) * 10e-3_pr
!
!               
          ELSE
