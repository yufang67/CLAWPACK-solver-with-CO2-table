...
!
!===============================================================================
!      SUBROUTINE corner_D(u_corner_D, v_corner_D, T_corner_D)
!===============================================================================
!
! It is necessary to evaluate the properties at the left low corner
! point of the
! Region 5
!
...
!
!        p_corner_D = 1d1       ! MPa
!        T_corner_D = 1073.15d0 !K 
!
!        u_corner_D = UPT2N(p_corner_D, T_corner_D)
!        v_corner_D = VPT2N(p_corner_D, T_corner_D)
!
