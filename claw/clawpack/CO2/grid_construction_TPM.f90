...
!
        ...
        v_left_TPM(2) = 2.144361289222370E-003
        v_left_TPM(3) = 2.150156894013743E-003
        

        T_guess =  304.128187656398
        v_guess =   2.150156894013743E-003
        vliq_guess = 2.125456277208737E-003


!        T_guess = T_cr - 0.0001_pr
!        v_guess =  1_pr/rho_cr + 1e-7_pr
!        vliq_guess = 1_pr/rho_cr - 1e-7_pr
!
        DO i=4, NNN_sat_TPM
...
!           IF( i == 2) THEN
!print*, 'in', y_mesh_sat_TPM(i), vliq_guess,v_guess,T_guess,i
          CALL New_Rap3D(4,vliq,v_left_TPM(i),Tsat,&
      &        res, Niter, flag, y_mesh_sat_TPM(i),in_2,&
      &        vliq_guess,v_guess, T_guess)
!print*,'spline left boundary', i, v_left_TPM(i),Tsat
!              
!          CALL New_Rap3D(4,vliq,v_left_TPM(i),Tsat,&
!      &        res,Niter,flag, y_mesh_sat_TPM(i),in_2,&
