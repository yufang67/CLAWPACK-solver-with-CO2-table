...
&                                         T_sat_pmax,res_pmax_LL,T_liq_meta,TT_guess,vv_guess
...
!         print*, vvv_LL(NNN_LL,MMM_LL), y_mesh_LL(NNN_LL), & 
!        & ppp_LL(NNN_LL,MMM_LL), TTT_LL(NNN_LL,MMM_LL)
!         stop
