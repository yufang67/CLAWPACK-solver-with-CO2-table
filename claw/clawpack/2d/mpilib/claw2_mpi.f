...
c     ==============================================================
c
c     # MPI Additions by Peter Blossey, 2003.  Based on work of
c     # Donna Calhoun & Sorin Mitran.
c
...
c$$$         call bc2_aux(maxmx,maxmy,meqn,mbc,mx,my,xlower,
c$$$     &         ylower,dx,dy,q,maux,aux,told,dt,mthbc)
c
c
