...
!     # Get transverse direction
    ...
    subroutine rotate2(rot,velcomps1,velcomps2)
    implicit none

    double precision :: rot(4), velcomps(2), v1, v2
    double precision :: velcomps1,velcomps2
    v1 = velcomps1
    v2 = velcomps2

    velcomps1 = rot(1)*v1 + rot(2)*v2
    velcomps2 = rot(3)*v1 + rot(4)*v2

    end subroutine rotate2

    subroutine rotate2_tr(rot,velcomps1,velcomps2)
    implicit none
    ...
    velcomps1 = rot(1)*v1 + rot(3)*v2
    velcomps2 = rot(2)*v1 + rot(4)*v2
